...
const menuSections: SidebarMenuSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "stock-view", label: "Stock by Location", icon: Warehouse },
      { id: "purchases", label: "Stock In (Purchases)", icon: Package },
      { id: "transfers", label: "Transfers", icon: Truck },
      { id: "stock-out", label: "Stock Out", icon: Package },
      { id: "stock-adjustment", label: "Stock Adjustment", icon: Warehouse },
      { id: "stock-movement-log", label: "Movement Log", icon: History },
    ...
    <>
      ...
      `}>
        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-gray-900">ACE STUDIOS</h1>
